...
bossview_1 = GameView(pygame.image.load("images/cs1.png"), screen)
boss_1 = GameControllers(bossmodel_1, bossview_1)

x = random.randint(0,500)
y = random.randint(0, 500)
bossmodel_2 = GameModel(x, 1)
bossview_2 = GameView(pygame.image.load("images/cs1.png"), screen)
boss_2 = GameControllers(bossmodel_2, bossview_2)

x = random.randint(0,500)
y = random.randint(0, 500)
bossmodel_3 = GameModel(x, 1)
bossview_3 = GameView(pygame.image.load("images/cs1.png"), screen)
